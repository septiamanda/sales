...
class FCCController extends BaseController
{
    ...
    {
        $fcc = $this->modelSales->where('status', 'FCC')->findAll();
        
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();

        $sheet->setCellValue('A2', 'Data FCC Telkom Witel Sumbar');
        ...
        header('Content-Disposition: attachment;filename=Data FCC.xlsx');
