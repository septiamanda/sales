...
class REController extends BaseController
{
    ...
    {
        $re = $this->modelSales->where('status', 'RE')->findAll();
        
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();

        $sheet->setCellValue('A2', 'Data RE Telkom Witel Sumbar');
        ...
        header('Content-Disposition: attachment;filename=Data RE.xlsx');
