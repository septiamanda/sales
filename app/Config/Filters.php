...
class Filters extends BaseConfig
{
    ...
    public array $globals = [
        ...
        'after' => [
            ...
            'filterKaryawan' => [
                'except' => ['dashboard', 'chartSales', 'pieSales', 'totalSales', 'totalRE', 'totalPI', 'totalPS', 'updateStatus', 'listRE', 'chartRE', 'listFCC', 'chartFCC', 'listPI', 'chartPI', 'listPS', 'chartPS', 'laporan', 'simpanSales', 'editSales', 'deleteSales*', 'growth','cariDataSales', 'listSales']
            ],
